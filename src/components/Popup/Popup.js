      ...
      <form  className="popup__form popup__cantainer">
        ...
        <div className="popup__container">
          ...
          <label className="popup__lable">
            <input id="post-title" className="popup__input popup__input_place" type="text" name="name" minLength="1" maxLength="30" placeholder="Название" autoComplete="off" required />
          </label>
          <label className="popup__lable">
            <input id="post-text" className="popup__input popup__input_image-url" type="text" name="textarea" placeholder="Введите текст" autoComplete="off" required />
          </label>
